...
## Simply pull the repository and use "sbt run" command to start the server on http://localhost:9000/

## Important: Make sure java (jdk) version 11.0.6 is used

Prerequisites include:

* Java Software Developer's Kit (SE) Version 11.0.6 (openjdk)
...
1. Use a command window to change into the example project directory, for example: `cd Concordia_SOEN6441_Fall_2021_AK_G01`
